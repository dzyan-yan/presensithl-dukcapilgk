...
<body id="page-top">
    ...
    if (isset($_POST['bsimpan'])) {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO absen_pulang (tanggal, bulan, waktu, username, nama_user, nik, uker, jabatan) VALUES ('$tgl', '$bulan', '$waktu', '$username', '$nama_user', '$nik', '$uker', '$jabatan')");
                                ...
                                <div class="card-body">
                                    <div class=" p-1">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-5">Presensi Pulang Kerja</h1>
                                        </div>
                                        <form class="user text-gray-900" method="POST" action="">
                                            ...
                                            <button type="submit" name="bsimpan" class="btn btn-primary btn-block">Presensi Pulang
                                            </button>

                                            <a href="home.php" class="btn btn-danger btn-block mt-5">Kembali</a>
