...
<head>
    ...
    <title>Halaman Pengisian Buku Kerja THL</title>
...
<body id="page-top">
    ...
    if (isset($_POST['bsimpan'])) {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO buku_kerja (tanggal_buat, bulan, waktu_buat, tanggal, nama_user, kegiatan, jumlah, satuan) VALUES ('$tgl', '$bulan', '$waktu', '$tanggal', '$nama_user', '$kegiatan', '$jumlah', '$satuan')");
                                ...
                                <div class="card-body">
                                    <div class=" p-1">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-5">Form Buku Kegiatan Kerja THL</h1>
                                        </div>
                                        <form class="user text-gray-900" method="POST" action="">
                                            ...
                                            <button type="submit" name="bsimpan" class="btn btn-primary btn-block mt-3">Simpan
                                            </button>

                                            <a href="home.php" class="btn btn-success btn-block mt-3">Kembali</a>
