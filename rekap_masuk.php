                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header text-center py-3">
                                        <h2 class="m-0 font-weight-bold text-primary">Rekapitulasi Presensi Masuk</h2>
                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered text-gray-900" id="mauexport" style="text-transform: capitalize" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $tampil = mysqli_query($koneksi, "SELECT * FROM absen_masuk where tanggal BETWEEN '$tanggal1' and '$tanggal2' order by id_absen asc");
                                                        $no = 1;
